...
//!	Generated Date	: Fri, 5, Apr 2019 
	File Path	: EXE/Host/Dishwasher/Dishwasher.java
*********************************************************************/
...
public class Dishwasher implements RiJStateConcept, Animated {
    ...
    public static AnimClass animClassDishwasher = new AnimClass("Dishwasher.Dishwasher",false);
    //#]
    ...
    public class Reactive extends RiJStateReactive implements AnimatedReactive {
        ...
        public int Running_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evOpen.evOpen_Dishwasher_id))
                {
        ...
        public int Open_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evClose.evClose_Dishwasher_id))
                {
                    res = OpenTakeevClose();
                }
        ...
        public int Off_takeEvent(short id) {
            int res = RiJStateReactive.TAKE_EVENT_NOT_CONSUMED;
            if(event.isTypeOf(evStart.evStart_Dishwasher_id))
                {
                    res = OffTakeevStart();
                }
